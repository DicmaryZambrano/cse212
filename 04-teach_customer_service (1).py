...
# Test 1
# Scenario: The user needs to specify the maximun size
#of the customer service queue
...
# Test 2
# Scenario: The add_new_customer function shall enqueue a new customer into the queue
# Expected Result: a new customer should be into the queue
print("Test 2")
